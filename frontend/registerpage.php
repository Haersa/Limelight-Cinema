...
if (isset($_SESSION['register_message'])) {
    ...
    <div class="failedtoast">
        <i class="fas fa-times-circle"></i> <?php echo $_SESSION['register_message']; ?>
    </div>
    <?php
...
<?php endif; ?>
 ...
 <main>
    <div class="register-container">
        <form class="register-form" action="createacct.php" method="POST" id="registerForm">
            <h2 class="register-title">Register your Account</h2>
            <p class ="register-subtitle">Join Limelight Cinema Today!</p>
            
            <div class="register-form-group">
                <div class="register-input-icon">
                    <i class="fas fa-user"></i>
                </div>
                <input type="text" id="username" name="username" class="register-input" placeholder="Username" required minlength="6">
            </div>
            ...
            <div class="register-form-group">
                ...
                <input type="password" id="password" name="password" class="register-input" placeholder="Password" required minlength="6">
            </div>
            ...
            <div class="register-form-group">
                ...
                <input type="password" id="confirmPassword" name="confirmPassword" class="register-input" placeholder="Confirm Password" required minlength="6">
            </div>
    ...
    <input type="date" id="dob" name="dob" class="register-input" placeholder = "dd/mm/yyyy" required>
</div>
            ...
            <div class="register-form-group">
                ...
                <select id="preferred_cinema" name="preferred_cinema" class="register-select" required>
                    ...
                    <option  value="Newtongrange">Newtongrange</option>
                </select>
            </div>

            <div class="newsletter-checkbox">
                <span class="register-newsletter-text">Subscribe to our Newsletter:</span>
                <input type="checkbox" name="newslettercheckbox" id="newslettercheckbox" value = "yes">
            </div>
            ...
            <div class="register-footer">
                ...
                <a href="loginpage.php" class="register-footer-link">Sign in</a>
            </div>
        </form>
    </div>
</main>
